        ...
        {isSignedIn ? (
          <>
            ...
            <div className="flex gap-3 pb-4">
              ...
              <button
                onClick={() => router.push("/quiz")}
                className="flex-1 py-4 bg-white text-black font-bold hover:bg-gray-100 transition-all duration-200"
              >
                다시 진단하기 →
              </button>
            </div>
          ...
          <div className="relative">
            <div className="space-y-6 pointer-events-none select-none blur-sm opacity-30">
              <div className="bg-white/5 border border-white/10 p-8">
                <h2 className="text-xl font-black text-white mb-6">학습 로드맵</h2>
                <div className="space-y-px" style={{ background: "rgba(255,255,255,0.06)" }}>
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="bg-black p-6 flex gap-4">
              ...
              <div className="bg-white/5 border border-white/10 p-8 h-52" />
            </div>
